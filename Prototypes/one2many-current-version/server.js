...
// on utilise socket.io pour crÃ©er deux variables de session Ã  transfÃ©rer aux clients
io.sockets.on('connection', function (socket, pseudo) {
    ...
    socket.on('nouveau_client', function (pseudo) {
        ...
        // On donne la liste des participants (Ã©vÃ©nement crÃ©Ã© du cÃ´tÃ© client)
    ...
    // Vider l'objet à  la dÃ©connexion
    ...
    socket.on('invitation', function (data) {
        ...
        var mailOptions = {
            ...
            text: 'Bonjour, ' + data.pseudo + ' vous invite Ã  rejoindre une room web RTC Ã  cette adresse : ' + data.url, // plaintext body
            html: '<b>Bonjour, ' + data.pseudo + ' vous invite Ã  rejoindre une room web RTC Ã  cette adresse : ' + data.url + '</b>' // html body
        };
    ...
    // Reception du fichiers pour la fonctionnalité d'envoi de fichiers.
...
// Demande du fichier du serveur si l'utilisateur accepte la réception
...
// Suppression du fichiers sur le serveur si l'utilisateur n'accepte pas la réception.
